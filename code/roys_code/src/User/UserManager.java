...
public class UserManager {
    ...
    public void viewReplay(int gameNumber) {
        FinishedGamesManager.getInstance().viewReplay(gameNumber);
    }
    ...
    public ArrayList<IGame> findActiveGamesByMaxPlayersPolicy(int maximal){throw new NotImplementedException();}
    //TODO: finish implementing this function
