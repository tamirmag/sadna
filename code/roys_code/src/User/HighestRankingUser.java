    ...
    public void moveUserToLeague(String username,int toLeague )
     ...
     /*   Scanner scanner = new Scanner(System.in);
        ...
        if (!username.equals("0")) {
            ...
            User u = LoginManager.getInstance().getUser(username);
            LoginManager.getInstance().removeUserFromLeague(u);
            System.out.println("User " + u.getUsername() + " was removed from league " + u.getLeague());
            ActionLogger.getInstance().writeToFile("User " + u.getUsername() + " was removed from league " + u.getLeague());
            ...
            */
            ...
            System.out.println("User " + u.getUsername() + " moved from league " + formerLeague + " to league " + toLeague);
            ActionLogger.getInstance().writeToFile("User " + u.getUsername() + " moved from league " + formerLeague + " to league " + toLeague);
